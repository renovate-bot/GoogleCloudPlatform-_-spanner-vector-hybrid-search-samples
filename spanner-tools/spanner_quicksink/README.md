...
> **Memory Configuration**: For high-throughput scenarios (e.g. large buffer windows or many partitions), increase the heap size before running:
> ```bash
> export MAVEN_OPTS="-Xmx48g -Xms48g"
> ```
...
heartbeatMs=10000
# Optional: Session Pool Configuration (default: 100/1000)
# Increase these if you have many active partitions (e.g. >400)
spanner.minSessions=100
spanner.maxSessions=1000
```
